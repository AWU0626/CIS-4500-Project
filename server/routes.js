...
const query6 = async function (req, res) {
  ...
  const maxEndGrade = req.query.max_end_grade ? req.query.max_end_grade : 12;
  const minEnrollment = req.query.min_enrollment ? req.query.min_enrollment : 0;
  const numChildren = req.query.num_children ? req.query.num_children : 1;
